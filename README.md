...
2. For each single key in list below click with the right button of mouse, click on "authorizations", click on "advances", on "authorizations" panel select "Users", YOURUSERNAME and "Administrators", "Disable hierarchy", the "Modify" and disable the "Full control" authorization;
