...
2. For each single key in list below click with the right button of mouse, click on "authorizations", click on "advanced", on "authorizations" panel select "Users", YOURUSERNAME and "Administrators", "Disable hierarchy", then click on "Modify" and disable the "Full control" authorization, click on "OK", "Apply" and "OK";
