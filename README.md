...
3. For each single key in list below click with the right button of mouse, click on Permissions", click on "advanced", on "authorizations" panel select "Users", YOURUSERNAME and "Administrators" (ONLY PRE-EXISTING USERS), "Disable inheritance", then click on "Modify" and disable the "Full control" authorization (LEAVING "READ-ONLY" ENABLED), click on "OK", "Apply" and "OK";
